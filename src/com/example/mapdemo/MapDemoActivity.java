...
public class MapDemoActivity extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		map.setInfoWindowAdapter(new CustomWindowAdapter(this.getLayoutInflater()));
	...
	public void onMapLongClick(final LatLng point) {
		...
		View MessageView = LayoutInflater.from(MapDemoActivity.this).inflate(
				R.layout.message_item, null);

		AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
				MapDemoActivity.this);
